...
ADD CONSTRAINT fktelefonecliente FOREIGN KEY(IDCLIENTE)
REFERENCES CLIENTE(IDCLIENTE)
ALTER TABLE TELEFONECLIENTE
ADD CONSTRAINT fktelefonecliente FOREIGN KEY(TIPOTELEFONE)
...
ALTER TABLE ENDERECOCLIENTE
ADD CONSTRAINT fkenderecocliente FOREIGN KEY(IDCLIENTE)
REFERENCES CLIENTE(IDCLIENTE)
ALTER TABLE ENDERECOCLIENTE
ADD CONSTRAINT fkenderecocliente FOREIGN KEY(IDCIDADE)
...
ALTER TABLE PRODUTO
ADD CONSTRAINT fkproduto FOREIGN KEY(IDGRUPO)
REFERENCES GRUPO(IDGRUPO)
ALTER TABLE PRODUTO
ADD CONSTRAINT fkproduto FOREIGN KEY(IDMARCA)
REFERENCES MARCA(IDMARCA)
ALTER TABLE PRODUTO
ADD CONSTRAINT fkproduto FOREIGN KEY(IDDEPARTAMENTO)
REFERENCES DEPARTAMENTO(IDDEPARTAMENTO)
...
ALTER TABLE VENDAITEM
ADD CONSTRAINT fkvendaitem FOREIGN KEY(IDPRODUTO)
...
INSERT INTO CLIENTEFISICO(IDCLIENTE, DATANASCIMENTO)
VALUES
(1, 10/11/2000),
(2, 25/03/2000)

INSERT INTO TELEFONECLIENTE(IDCLIENTE, NUMERO)
VALUES
(1, 992318202),
(2, 988585049)

INSERT INTO ENDERECOCLIENTE(IDCLIENTE, CEP)
VALUES
(1, 38182805),
(2, 38182112)
...
/*EXERC 4*/
UPDATE TIPOTELEFONE SET DESCRICAO = 'WHATSAPP' 
WHERE IDTIPOTELEFONE = 5
...
/*EXERC 18*/
SELECT * FROM PRODUTO WHERE DATACADASTRO IN (01/01/2019 * 31/12/2020)
